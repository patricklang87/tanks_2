...
const DriveControls = () => {
    ...
    return (_jsx("div", { className: "align-items-center", children: _jsxs("div", { className: "row", children: [_jsx("div", { className: "col-2", children: _jsx(Form.Label, { children: "Drive to" }) }), _jsx("div", { className: "col-1", children: _jsx("span", { children: driveDistance }) }), _jsxs("div", { className: "col-9", children: [" ", _jsx(Form.Range, { value: driveDistance, onChange: (e) => dispatch(setCurrentTankDriveDistance(Number(e.target.value))), id: driveInputId, name: "driveDistance", min: -150, max: 150 })] })] }) }));
};

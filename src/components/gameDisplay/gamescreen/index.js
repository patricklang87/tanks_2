...
const GameScreen = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "title-container", children: [" ", _jsx("h1", { className: "title-card", children: "Tanks A Million!" })] }), showWinnerPopup && _jsx(WinnerPopup, {}), _jsxs("div", { className: "canvas-container", style: {
